...
public class UserController {
    ...
    @Autowired
    private CreateUserToDisplayUserTransformer createUserToDisplayUserTransformer;
    ...
    public @ResponseBody DisplayUserDTO updateUser(@PathVariable("id") Integer id, @RequestBody CreateUserDTO createUserDTO) {
        try {
            ...
            return createUserToDisplayUserTransformer.transform(createNewUserDTO);
        } catch (Exception e) {
            logger.log(Level.SEVERE, "The update failed. No user found with id " + id + ".");
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, e.getMessage(), e);
        }
    }
    ...
    public @ResponseBody Set<DisplayBookDTO> getUserBooks(@PathVariable("user_id") Integer id) {
        try {
